...
func ConvertToEnv(variables map[string]string) string {
	output := ""
...
func ConvertToJson(variables map[string]string) string {
...
func main() {
	...
	jsonHandler := func(w http.ResponseWriter, r *http.Request) {
		...
		output := ConvertToJson(variables)
